        ...
        <div class="container py-4">
          <article class="postcard dark yellow">
            <Link to="/review-details" class="postcard__img_link">
              <img
                class="postcard__img"
                src="https://www.gameshub.com/wp-content/uploads/sites/5/2022/11/sonic-frontiers-review.jpg"
                alt="Review preview"
              />
            </Link>
            <div class="postcard__text">
              ...
              <div class="postcard__preview-txt">
                The open-world adventure is brilliant in terms of input and
                response at the expense of any discernible logic
              </div>
              <p>
                Autor: <b>Wild gamer</b>
              </p>
              <p>
                Rating: <b>6/10</b>
              </p>
